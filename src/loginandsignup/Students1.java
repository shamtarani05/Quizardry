...
public class Students1 extends javax.swing.JFrame {
     ...
     public void setadminnames2(String Text)
    {
        admin1.setText(Text);
    }
    /**
    ...
    private void initComponents() {
        ...
        student_table1.setFont(new java.awt.Font("Rockwell", 1, 14)); // NOI18N
        student_table1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Sr", "Name", "Student_id", "Password"
            }
        ) {
        ...
        student_table1.setRowHeight(50);
        student_table1.setSelectionForeground(new java.awt.Color(255, 255, 255));
        student_table1.setShowGrid(true);
        student_table1.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(student_table1);
    ...
    ArrayList<String> students = Admin.Students(Loginandsignup.name);

    // Get the existing DefaultTableModel from the JTable
    DefaultTableModel quizzesModel = (DefaultTableModel) student_table1.getModel();
...
int j =1;
    for (int i = 0; i < students.size(); i += 3) {
        ...
        String id =  students.get(i+1);
        String password = students.get(i + 2);
        Object[] rowData = {j,name,id,password };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Students1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
