...
public class Quizresult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Result_Table1.setRowHeight(50);
        Result_Table1.setShowGrid(true);
        jScrollPane1.setViewportView(Result_Table1);
  ...
  public void add() {
    ...
    System.out.println(Admin_Result.quizid);
    ArrayList<String> resultList = user.getResult(Admin_Result.quizid,Loginandsignup.name);

    // Get the existing DefaultTableModel from the JTable
    DefaultTableModel quizzesModel = (DefaultTableModel) Result_Table1.getModel();
    ...
    for (int i = 0; i < resultList.size(); i += 3) {
        String quiz_id = resultList.get(i);
        String Student_name = resultList.get(i + 1);
        Double Marks = Double.parseDouble(resultList.get(i + 2));
        Object[] rowData = {j,quiz_id,Student_name,Marks};
